...
\begin{abstract}
Probabilmente non basterebbero le (quasi) 100 pagine di questa tesi per ringraziare tutte le persone che mi hanno aiutato ad arrivare fin qui. Ma come mi hanno insegnato queste stesse persone, se hai un obiettivo è importante provarci dando tutto te stesso. Grazie a:
\begin{itemize}
\item Mamma, Papà, Rossana e Enzo. Siete il mio porto sicuro.
\item Mia nonna Giovanna "Rosa", che semplicemente ha sempre creduto in me.
\item Marco "Mura" e Francesco De Sanctis, con cui ho passato intere giornate, fine settimana, notti a studiare. 
\item Stefano e Chiara che mi sopportate sempre nei miei scleri.
\item Ruben, Virginia, Massi, Alby e tutto il gruppo degli "Sgianmarcatori", per essermi sempre vicino.
\item Giorgia, Gandi e Marti, per le nostre giornate di studio matto e disperatissimo.
\item Fabio Mancini e Roberta Coscia, i miei amici lontani che nonostante la distanza sono sempre presenti.
\item Il mio gruppo di "pillole" di supporto, che oltre a sopportare i miei sfoghi è diventato una seconda famiglia per me. 
\item Il mio (ex) collega e amico Lorenzo Rossi, per tutte le corse folli che abbiamo fatto per superare gli esami mentre lavoravamo.
\item Matteo Maffetti, Cristiano Aitis, Alessandra Saitta, Carlo Bono e Mauro Magnacavallo, che mi hanno consigliato e supportato sempre.
\item I miei vecchi amici dell' Auletta Computer Club, la cui presenza mi ha fatto amare via Comelico.  
\item I miei relatori, il  Prof. Giorgio Valentini e il Dr. Marco Notaro. Che oltre ad essere un pozzo di conoscenza e competenza, sono forse tra le persone più disponibili e pazienti che abbia mai conosciuto.
\item Tutti i professori che mi hanno fatto amare l'Informatica.
\end{itemize} 
\end{abstract}
