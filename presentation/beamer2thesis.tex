...
\begin{tframe}{Metodo True Path Rule per DAG (TPR-DAG) (1/2)}
\begin{itemize}
\onslide<1->
...
\begin{tframe}{Generalized Pool Adjacent Violator (GPAV) (5/5)}
...
\end{tframe}
\begin{tframe}{\footnotesize{Predizione della funzione delle proteine della specie C.elegans (WORM) 1/5}}
...
\begin{tframe}{\footnotesize{Predizione della funzione delle proteine della specie C.elegans (WORM)} 2/5}
\begin{figure}
\includegraphics[scale=0.2]{img/STRING-NET.png}
\caption{\footnotesize{Una porzione del grafo STRING per la specie WORM.}}
\end{figure}
\end{tframe}
\begin{tframe}{\footnotesize{Predizione della funzione delle proteine della specie C.elegans (WORM)} 3/5}
...
\begin{tframe}{\footnotesize{Predizione della funzione delle proteine della specie C.elegans (WORM)} 4/5}
...
\begin{tframe}{\footnotesize{Predizione della funzione delle proteine della specie C.elegans (WORM)} 5/5}
