  ...
  \begin{columns}
    ...
    \begin{column}{.75\textwidth}
      \minipage[c][0.4\textheight][s]{\columnwidth}
	   \begin{itemize}	
	   \onslide<1->
	  \item la predizione della funzione delle proteine attraverso le analisi con sperimentazione diretta in laboratorio è \highlightbf{costosa} e richiede \highlightbf{molto tempo}
	  \onslide<2->
...
\begin{itemize}
\onslide<3->
\item \highlightbf{Functional Catalogue} (FunCat)
\onslide<4->
\item \highlightbf{Gene Ontology} (GO)
\end{itemize}
\end{itemize}  
